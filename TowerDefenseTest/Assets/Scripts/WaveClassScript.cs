...
{
    // Public variables
    public GameObject enemy; // Which enemy that wave is going to spawn TODO : Add a list to allow for waves to spawn different kinds of enemies  // Idea on wave spawner 2.0 episode comment
